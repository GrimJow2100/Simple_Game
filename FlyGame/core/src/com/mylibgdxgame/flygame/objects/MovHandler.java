...
//Класс, который отвечает за создание травы и паутины
public class MovHandler {

    private  Grass frontGrass, backGrass;
    private Web web1, web2, web3;
   //Констатны для скорости объектов и просветов между паутиной
    ...
    public MovHandler(GameWorld gameWorld, float yPos) {
        ...
        //Иницилизация конструктора и передача параметров X, T, скорость прокрутки, Высоту и Ширину
        //Объекты backGrass и frontGrass должны состыковаться, что бы не было разрывов в картинке
    ...
    public void update(float delta) {
        ...
        //Проверка объектов на выход за границы экрана
        ...
        //Сбрасываем параметры вышедших объектов
    ...
    //Метод для остановки при столкновении объектов
    public void stop() {
        frontGrass.stop();
        backGrass.stop();
        web1.stop();
...
//Метод collides вернет true в случае столновения мужи с препятствиями
    //также здесь логика счета
